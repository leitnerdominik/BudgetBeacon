...
namespace BudgetBeacon.Api.Infrastructure;
    ...
    private static (int StatusCode, string Title, string Detail, string Type) MapException(Exception exception) =>
        exception switch
        {
            InvalidInputException invalidInput => (
                ...
                "urn:budgetbeacon:invalid-input"),
            ...
            AntiforgeryValidationException => (
                ...
                "urn:budgetbeacon:invalid-csrf-token"),
            BadHttpRequestException => (
                StatusCodes.Status400BadRequest,
                "Invalid HTTP request",
                "The request could not be processed.",
                "urn:budgetbeacon:bad-http-request"),
            _ => (
                StatusCodes.Status500InternalServerError,
                "Unexpected server error",
                "An unexpected error occurred. Please try again later.",
                "urn:budgetbeacon:server-error")
        };
}
